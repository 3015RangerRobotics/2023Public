...
public class ThreeLoading extends SequentialCommandGroup {
  public ThreeLoading(SwerveAutoBuilder autoBuilder, boolean isBlue) {
    List<PathPlannerTrajectory> pathGroup =
        PathPlanner.loadPathGroup(
            "3Loading" + (isBlue ? "Blue" : ""),
    ...
    addCommands(
        ...
        AutoBuildingBlocks.outtakeGamePiece(),
        new ArmToSafePos(true).alongWith(autoBuilder.followPathWithEvents(pathGroup.get(4))));
  }
}
