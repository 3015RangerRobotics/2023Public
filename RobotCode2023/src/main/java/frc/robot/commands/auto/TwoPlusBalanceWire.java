...
public class TwoPlusBalanceWire extends SequentialCommandGroup {
  public TwoPlusBalanceWire(SwerveAutoBuilder autoBuilder, boolean isBlue) {
    List<PathPlannerTrajectory> pathGroup =
        PathPlanner.loadPathGroup(
            "2+Balance Wire" + (isBlue ? "Blue" : ""),
