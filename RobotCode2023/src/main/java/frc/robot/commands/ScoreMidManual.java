...
public class ScoreMidManual extends CommandBase {

  public ScoreMidManual() {
  ...
  public void execute() {
    if (RobotContainer.isCubeMode()) {
      RobotContainer.pinkArm.setArmGoalPosition(
          Constants.ScoreMidManual.cubePinkArmLength, Constants.ScoreMidManual.cubePinkArmAngle);
    } else {
      RobotContainer.pinkArm.setArmGoalPosition(
